  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 py-4 bg-background border-b-4 border-primary hard-shadow">
      <div className="flex items-center gap-2 max-w-[50%] sm:max-w-none overflow-hidden">
        <DollarSign className="text-primary font-bold shrink-0" size={24} />
        <h1 className="text-xl md:text-3xl font-black text-primary italic tracking-tighter uppercase whitespace-nowrap overflow-hidden text-ellipsis">
          INTO THE MISSION
        </h1>
      </div>
